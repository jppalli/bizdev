...
drop table if exists public.game_evaluation_scores cascade;
drop table if exists public.game_evaluations cascade;
...
grant select, insert, update, delete on table public.planning_games to anon, authenticated;
...
drop policy if exists "allow authenticated delete planning games" on public.planning_games;
create policy "allow authenticated delete planning games"
on public.planning_games for delete
to anon, authenticated using (true);
